...
namespace sw
{
    namespace redis
    {
        ...
        {
            auto reply = command<void (*)(Connection &, const StringView &, const StringView &)>(cmd::auth, user, password);
        ...
        void Redis::restore(const StringView &key, const StringView &val, long long ttl, bool replace)
        {
        ...
        long long Redis::bitpos(const StringView &key, long long bit, long long start, long long end)
        {
        ...
        void Redis::psetex(const StringView &key, long long ttl, const StringView &val)
        {
        ...
        bool Redis::set(const StringView &key, const StringView &val, const std::chrono::milliseconds &ttl, UpdateType type)
        {
        ...
        bool Redis::set(const StringView &key, const StringView &val, bool keepttl, UpdateType type)
        {
        ...
        void Redis::setex(const StringView &key, long long ttl, const StringView &val)
        {
        ...
        OptionalString Redis::brpoplpush(const StringView &source, const StringView &destination, long long timeout)
        {
        ...
        long long Redis::linsert(const StringView &key, InsertPosition position, const StringView &pivot, const StringView &val)
        {
        ...
        bool Redis::smove(const StringView &source, const StringView &destination, const StringView &member)
        {
        ...
        auto Redis::bzpopmax(const StringView &key, long long timeout) -> Optional <std::tuple<std::string, std::string, double>>
        {
        ...
        auto Redis::bzpopmin(const StringView &key, long long timeout) -> Optional <std::tuple<std::string, std::string, double>>
        {
        ...
        long long Redis::zadd(const StringView &key, const StringView &member, double score, UpdateType type, bool changed)
        {
        ...
        long long Redis::geoadd(const StringView &key, const std::tuple<StringView, double, double> &member)
        {
        ...
        OptionalDouble Redis::geodist(const StringView &key, const StringView &member1, const StringView &member2, GeoUnit unit)
        {
        ...
        OptionalLongLong Redis::georadius(const StringView &key, const std::pair<double, double> &loc, double radius, GeoUnit unit, const StringView &destination, bool store_dist, long long count)
        {
            auto reply = command(cmd::georadius_store, key, loc, radius, unit, destination, store_dist, count);
        ...
        OptionalLongLong Redis::georadiusbymember(const StringView &key, const StringView &member, double radius, GeoUnit unit, const StringView &destination, bool store_dist, long long count)
        {
            auto reply = command(cmd::georadiusbymember_store, key, member, radius, unit, destination, store_dist, count);
        ...
        void Redis::xgroup_create(const StringView &key, const StringView &group, const StringView &id, bool mkstream)
        {
        ...
        long long Redis::xgroup_delconsumer(const StringView &key, const StringView &group, const StringView &consumer)
        {
